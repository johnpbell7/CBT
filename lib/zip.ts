 ...
 *
 * A dependency-free export: the audio is already compressed, so deflating it
 * again would buy nothing, and shipping a zip library to every visitor for a
 * button most people press once is a poor trade.
 */
